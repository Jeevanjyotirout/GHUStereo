...
parser = argparse.ArgumentParser(description='GHUStereo')
parser.add_argument('--model', default='GHUStereo', help='select a model structure', choices=__models__.keys())
parser.add_argument('--backbone', default='efficientnet_b2a', help='select a model structure', choices=["mobilenetv2_100", "efficientnet_b2a", "mpvit"])
parser.add_argument('--maxdisp', type=int, default=192, help='maximum disparity')
parser.add_argument('--datapath', default='/datasets/ETH3D/', help='data path')
parser.add_argument('--loadckpt', default='./checkpoint/ghustereo8_efficientnet_backbone_nc.ckpt',help='load the weights from a specific checkpoint')
